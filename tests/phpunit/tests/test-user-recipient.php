...
use WP\Notifications\Recipients\User_Recipient;

class Test_User_Recipient extends TestCase {

	public function test_it_can_be_instantiated() {
		$testee = new User_Recipient( 1 );
		$this->assertInstanceOf( '\WP\Notifications\Recipients\User_Recipient', $testee );
	}
	...
	public function test_it_throws_on_invalid_type( $invalid_user_id ) {
		...
		new User_Recipient( $invalid_user_id );
	}
