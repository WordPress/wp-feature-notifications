window.addEventListener("load", () => {
  ...
  document.getElementById("wp-notification-metabox-form").addEventListener("submit", function (e) {
    e.preventDefault();
    const title = document.getElementById("wp-notification-metabox-form-title").value;
    const message = document.getElementById("wp-notification-metabox-form-message").value;
