...
register_activation_hook( realpath( __DIR__ . '/../wp-feature-notifications.php' ), '\WP\Notifications\activation_hook' );
...
register_uninstall_hook( realpath( __DIR__ . '/../wp-feature-notifications.php' ), '\WP\Notifications\uninstall_hook' );
